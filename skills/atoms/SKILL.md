...
description: Full reference for createAtom — signature, base methods, object-only methods, lifecycle events, registry helpers, and usage examples.
when_to_use: |
  - User calls or imports createAtom from @mongez/atom
  - User asks about atom.update, atom.merge, atom.change, atom.watch, or atom.reset
  - User asks how to define an atom with a key and default value
  - User asks about atom.onChange, atom.onReset, atom.onDestroy, or atom.clone
  - User asks about getAtom, atomsList, or atomsObject registry helpers
  - User asks about the beforeUpdate guard or the get option on AtomOptions
---
