...
when_to_use: |
  - User calls or imports createAtom
  - User calls or imports atomCollection
  - User asks how to add methods (actions) to an atom
  - User asks how to type an atom's value
  - User asks about merge, change, watch, silentUpdate, beforeUpdate
  - User asks how to subscribe to atom changes with onChange or watch
---
