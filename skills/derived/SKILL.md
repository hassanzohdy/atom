...
description: How to create computed atoms with derive() — auto-tracked dependencies, dynamic dep graphs, chaining, and React consumption.
when_to_use: |
  - User imports or calls derive from @mongez/atom
  - User asks how to create a computed or derived atom
  - User asks about automatic dependency tracking across atoms
  - User asks about dynamic dependency graphs (conditional reads inside compute)
  - User asks about chaining derived atoms (derived from derived)
  - User asks how to consume a derived atom with useValue or useState in React
---
